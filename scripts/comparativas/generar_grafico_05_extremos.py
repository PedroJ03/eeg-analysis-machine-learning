...
def generar_grafico_05():
    df, feature_order, feature_names = load_data()
    df_task = df[df['Task'] == 'extremes']
    models = ['rf', 'svm']
    ...
    for model, label in zip(models, model_labels):
        ...
        ax.set_title(f'Accuracy por Features Individuales - Extremos\n({label})', fontweight='bold', pad=20)
        ...
        filename = f"05_features_EXTREMOS_{suffix}.png"

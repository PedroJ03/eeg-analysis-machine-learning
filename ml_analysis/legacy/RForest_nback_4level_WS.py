...
# -------------------- ENTRENAMIENTO WITHIN-SUBJECT (RANDOM FOREST 4 NIVELES) -------------------- #
...
for path in subject_paths:
    ...
    print(f"✅ {subj_name}: precisión media (5-fold, 4 niveles) = {subj_acc:.3f}")

# -------------------- RESULTADOS FINALES -------------------- #

if all_accuracies:
    print("\n📈 RESULTADOS GLOBALES (Within-subject, 4 niveles)")
